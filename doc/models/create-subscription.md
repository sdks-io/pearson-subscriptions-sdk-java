...
|  --- | --- | --- | --- | --- | --- |
| `Terms` | [`Terms`](../../doc/models/terms.md) | Optional | Container for the terms and renewal settings of the subscription. | Terms getTerms() | setTerms(Terms terms) |
| `SubscribeToRatePlans` | [`List<SubscribeToRatePlan>`](../../doc/models/subscribe-to-rate-plan.md) | Optional | - | List<SubscribeToRatePlan> getSubscribeToRatePlans() | setSubscribeToRatePlans(List<SubscribeToRatePlan> subscribeToRatePlans) |
